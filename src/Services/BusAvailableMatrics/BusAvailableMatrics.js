   ...
   console.log(regno)
    if(filtervalue==="buswise"){
      await Busavailability_service.buswisedata(regno).then((res)=>{
        ...
        if(Boolean(props.pto)){
            await Busavailability_service.datewisedatapto(datearray[0],datearray[1],props.pto).then((res)=>{
                setReportDetails({
                    countWayBillTrips: res.data.count,
                    countWayBillTripsWhereTimeIsNotZero: 0,
                    wayBillTripsList: res.data.records,
        ...
        await Busavailability_service.datewisedata(datearray[0],datearray[1]).then((res)=>{
            setReportDetails({
                countWayBillTrips: res.data.count,
                countWayBillTripsWhereTimeIsNotZero: 0,
                wayBillTripsList: res.data.records,
